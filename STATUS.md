...
*(Older bullets — the PNT `3/2−o(N)` frontier-closing lap (`weakPNT` first cited), — the two-sided refined-Chebyshev `15/16`+`6/5` lap, the refined-Chebyshev prerequisite
